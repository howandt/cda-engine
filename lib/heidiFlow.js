...
function buildHeidiFlowInstructions({
  ...
  const heidiShapeInstructions = [
    "24A.2 HEIDISTEMME — KVALITET OG FLOW",
    ...
    "Skabeloner kan nævnes som korte forslag nederst, fx 'Pausekort kan være relevant', men skabelonindhold må aldrig åbnes uden tydeligt bruger-kald.",
