...
function buildHeidiFlowInstructions({
  ...
  const heidiShapeInstructions = [
    ...
    "Hvis der i CDA-grundlaget findes relevante pbl_suggestions, og beskeden tydeligt afslører en reel interesse eller styrke hos barnet (fx et konkret emne, eleven fordyber sig i), kan du kort nævne ét af dem som en mulig praktisk vej, fx: 'Han lyder som en, der kunne have gavn af et PBL-forløb med [emne] som indgang.' Nævn det kun, hvis det giver ægte mening ud fra det brugeren faktisk har skrevet, og opfind aldrig en interesse. Start ikke selve PBL-forløbet her, og lav ikke en fuld PBL-analyse; det er lærerens valg at gå videre.",
